        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CompanyAndBoothNumber = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: false),
                    ...
                    AfterDiscussionNotes = table.Column<string>(type: "text", nullable: false)
                },
                constraints: table =>
                {
